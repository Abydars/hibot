            ...
            <form method="post" enctype="multipart/form-data">
                <div class="tile-body">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="reg-name" value="<?= print_val( 'reg-name' ) ?>" type="text"
                               placeholder="Enter full name">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Date Of Birth</label>
                        <input class="form-control" value="<?= print_val( 'reg-dob' ) ?>" id="reg-dob" name="reg-dob"
                               type="text" placeholder="Select Date Of Birth">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Address</label>
                        <textarea class="form-control" name="reg-address" rows="4"
                                  placeholder="Enter your address"> <?= print_val( 'reg-address' ) ?></textarea>
                    </div>
                    <div class="form-group">
                        <label class="control-label">City</label>
                        <input class="form-control col-md-4" name="reg-city" type="text" placeholder="Enter City"
                               value="<?= print_val( 'reg-city' ) ?>">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Country</label>
                        <input class="form-control col-md-4" value="<?= print_val( 'reg-country' ) ?>"
                               name="reg-country" type="text" placeholder="Enter Country">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Phone Number</label>
                        <input class="form-control col-md-4" name="reg-phone" type="number"
                               value="<?= print_val( 'reg-phone' ) ?>" placeholder="Enter Your CellPhone Number">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Your Age</label>
                        <input class="form-control col-md-4" name="reg-age" type="number" placeholder="Enter Your Age"
                               value="<?= print_val( 'reg-age' ) ?>">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Blood Group</label>
                        <input class="form-control col-md-4" value="<?= print_val( 'reg-bloodgroup' ) ?>"
                               name="reg-bloodgroup" type="text" placeholder="Enter Your Blood Group">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Your Previous Physicians</label>
                        <input class="form-control col-md-4" name="physicians[]"
                               value="<?= print_val( 'physicians', 0 ) ?>" type="text"
                               placeholder="Enter Name Of Physician">
                        <br/>
                        <input class="form-control col-md-4" name="physicians[]"
                               value="<?= print_val( 'physicians', 1 ) ?>" type="text"
                               placeholder="Enter Name Of Physician">
                        <br/>
                        <input class="form-control col-md-4" name="physicians[]"
                               value="<?= print_val( 'physicians', 2 ) ?>" type="text"
                               placeholder="Enter Name Of Physician">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="reg-healthy"
                                       value="1" <?= isChecked( 'reg-healthy', "1" ) ?>>1
                            </label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="reg-healthy"
                                       value="2" <?= isChecked( 'reg-healthy', "2" ) ?>>2
                            </label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="reg-healthy"
                                       value="3" <?= isChecked( 'reg-healthy', "3" ) ?>>3
                            </label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="reg-healthy"
                                       value="4" <?= isChecked( 'reg-healthy', "4" ) ?>>4
                            </label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="reg-healthy"
                                       value="5" <?= isChecked( 'reg-healthy', "5" ) ?>>5
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="reg-gender"
                                       value="male" <?= isChecked( 'reg-gender', "male" ) ?>>Male
                            </label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="reg-gender"
                                       value="female" <?= isChecked( 'reg-gender', "female" ) ?>>Female
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="reg-injury"
                                       value="yes" <?= isChecked( 'reg-injury', "yes" ) ?>>Yes
                            </label>
                        </div>
                        <div class="form-group">
                            <textarea class="form-control" name="reg-injuryreason" rows="4"
                                      placeholder="Enter Details of Your Injury"><?= print_val( 'reg-injuryreason' ) ?></textarea>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="reg-injury"
                                       value="no" <?= isChecked( 'reg-injury', "no" ) ?>>No
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="reg-disease"
                                       value="yes" <?= isChecked( 'reg-disease', "yes" ) ?>>Yes
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        <input class="form-control col-md-5" name="diseases[]" value="<?= print_val( 'diseases', 0 ) ?>"
                               type="text" placeholder="Enter The Name Of Disease Eg: Sugar">
                        <br/>
                        <input class="form-control col-md-5" name="diseases[]" value="<?= print_val( 'diseases', 1 ) ?>"
                               type="text" placeholder="Enter The Name Of Disorder Eg: Bp">
                        <br/>
                        <input class="form-control col-md-5" name="diseases[]" value="<?= print_val( 'diseases', 2 ) ?>"
                               type="text" placeholder="Enter The Name Of Disease Eg: cancer">
                        <br/>
                        <input class="form-control col-md-5" name="diseases[]" value="<?= print_val( 'diseases', 3 ) ?>"
                               type="text" placeholder="Enter The Name Of Disease Eg: Migraine">
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input class="form-check-input" type="radio" name="reg-injury"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-4" name="medicines[]"
                               value="<?= print_val( 'medicines', 0 ) ?>" type="text"
                               placeholder="Enter Name of medicine">
                        <br/>
                        <input class="form-control col-md-4" name="medicines[]"
                               value="<?= print_val( 'medicines', 1 ) ?>" type="text"
                               placeholder="Enter Name of medicine">
                        <br/>
                        <input class="form-control col-md-4" name="medicines[]"
                               value="<?= print_val( 'medicines', 2 ) ?>" type="text"
                               placeholder="Enter Name of medicine">
                        </br>
                        <textarea class="form-control" name="reg-medicinereason" rows="4"
                                  placeholder="Reason To Use These"><?= print_val( 'reg-medicinereason' ) ?></textarea>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><strong>ClICK ON BUTTON TO VIEW PARTICULAR
                                FORM</strong></label></br>
                    ...
                    <div class="form-group" id="contentchest" style="display:none">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="chest[discomfort]" rows="4"
                                      placeholder="Detail here"><?= print_val( 'discomfort', 0, 'chest' ) ?></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[occur]"
                                           value="onceaday" <?= isChecked( 'occur', "onceaday", 'chest' ) ?>>Once a day
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[occur]"
                                           value="onceaweek <?= isChecked( 'occur', "onceaweek", 'chest' ) ?>">Once a
                                    week
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[occur]"
                                           value="onceamonth" <?= isChecked( 'occur', "onceamonth", 'chest' ) ?>>Once a
                                    month
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[occur]"
                                           value="morefrequently" <?= isChecked( 'occur', "morefrequently", 'chest' ) ?>>More
                                    frequently
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label">Check the following words that describe your chest
                                discomfort:</label>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[describe]"
                                           value="sharp" <?= isChecked( 'describe', "sharp", 'chest' ) ?>>Sharp
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[describe]"
                                           value="burning" <?= isChecked( 'describe', "burning", 'chest' ) ?>>Burning
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[describe]"
                                           value="tightness" <?= isChecked( 'describe', "tightness", 'chest' ) ?>>Tightness
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[describe]"
                                           value="stabbing" <?= isChecked( 'describe', "stabbing", 'chest' ) ?>>Stabbing
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[describe]"
                                           value="fullness" <?= isChecked( 'describe', "fullness", 'chest' ) ?>>Fullness
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[describe]"
                                           value="crushing" <?= isChecked( 'describe', "crushing", 'chest' ) ?>>Crushing
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[describe]"
                                           value="aching" <?= isChecked( 'describe', "aching", 'chest' ) ?>>Aching
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[describe]"
                                           value="pinching" <?= isChecked( 'describe', "pinching", 'chest' ) ?>>Pinching
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[radiate]"
                                           value="rightarm" <?= isChecked( 'radiate', "rightarm", 'chest' ) ?>>Right arm
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[radiate]"
                                           value="leftarm" <?= isChecked( 'radiate', "leftarm", 'chest' ) ?>>Leftarm
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[radiate]"
                                           value="neck" <?= isChecked( 'radiate', "neck", 'chest' ) ?>>Neck
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input"
                                           value="jaw"<?= isChecked( 'radiate', "jaw", 'chest' ) ?> type="radio"
                                           name="chest[radiate]">Jaw
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio"
                                           value="teeth" <?= isChecked( 'radiate', "teeth", 'chest' ) ?>
                                           name="chest[radiate]">Teeth
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[radiate]"
                                           value="throat" <?= isChecked( 'radiate', "throat", 'chest' ) ?>>Throat
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input"
                                           value="shoulder" <?= isChecked( 'radiate', "shoulder", 'chest' ) ?>
                                           type="radio" name="chest[radiate]">Shoulder
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio"
                                           value="back" <?= isChecked( 'radiate', "back", 'chest' ) ?>
                                           name="chest[radiate]">Back
                                </label>
                            </div>
                            solo
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[long]" value="less1min">Less
                                    than 1 minute
                                </label>
                            </div>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[long]"
                                           value="morethan5min">1-5 minutes
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[long]"
                                           value="morethan30min">6-30 minutes
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="chest[long]" value="1hr">More
                                    than 1hour
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label">Have you ever been hospitalized because of this
                                discomfort?</label>
                            <div class="form-check">
                                <label class="form-check-label">
                        ...
                        <div class="form-group">
                            <label class="control-label">ON a scale of 1 to 5 rate your chest discomfort(5 being the
                                most intense and 1 being the least intense)</label>
                            <div class="form-check">
                                <label class="form-check-label">
                    ...
                    <div class="form-group" id="contentheart" style="display:none">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="reg-select" name="heart[notice]" type="text"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="heart[stop]"
                                           value="stopsuddenly">Suddenly
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="heart[stop]"
                                           value="stopgradually">Gradually
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label">Are there activities, foods, etc. that can bring it
                                on? </label>
                            <div class="form-check">
                                <label class="form-check-label">
                            ...
                            <input class="form-control col-md-5" name="heart[bring1]" type="text"
                                   placeholder="Enter Activity Or Food">
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                        ...
                        <div class="form-group">
                            <div class="animated-checkbox">
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="chestpain" <?= isChecked( 'symtoms', 'chestpain', 'heart' ) ?>><span
                                            class="label-text">Chest Pain</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="dizz" <?= isChecked( 'symtoms', 'dizz', 'heart' ) ?>><span
                                            class="label-text">Dizziness</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="sweaty" <?= isChecked( 'symtoms', 'sweaty', 'heart' ) ?>><span
                                            class="label-text">Sweaty</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="breathing" <?= isChecked( 'symtoms', 'breathing', 'heart' ) ?>><span
                                            class="label-text">Breathing difficulty</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="discomfort" <?= isChecked( 'symtoms', 'discomfort', 'heart' ) ?>><span
                                            class="label-text">Discomfort</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="headache" <?= isChecked( 'symtoms', 'headache', 'heart' ) ?>><span
                                            class="label-text">Headache</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="stomach" <?= isChecked( 'symtoms', 'stomach', 'heart' ) ?>><span
                                            class="label-text">Sick Stomach</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="insomnia" <?= isChecked( 'symtoms', 'insomnia', 'heart' ) ?>><span
                                            class="label-text">Insomnia</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="bodypain" <?= isChecked( 'symtoms', 'bodypain', 'heart' ) ?>><span
                                            class="label-text">Body Pain</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="lowenergy" <?= isChecked( 'symtoms', 'lowenergy', 'heart' ) ?>><span
                                            class="label-text">Energy Loss</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="lowbp" <?= isChecked( 'symtoms', 'lowbp', 'heart' ) ?>><span
                                            class="label-text">Low Blood Pressure</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="hibp" <?= isChecked( 'symtoms', 'hibp', 'heart' ) ?>><span
                                            class="label-text">High Blood Pressure</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="fever" <?= isChecked( 'symtoms', 'fever', 'heart' ) ?>><span
                                            class="label-text">Fever</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="cough" <?= isChecked( 'symtoms', 'cough', 'heart' ) ?>><span
                                            class="label-text">Cough Problem</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="heart[symtoms][]"
                                           value="none" <?= isChecked( 'symtoms', 'none', 'heart' ) ?>><span
                                            class="label-text">None</span> &nbsp;&nbsp;
                                </label>
                    ...
                    <div class="form-group" id="contentkidney" style="display:none">
                        ...
                        <div class="form-group">
                            <label class="control-label">How long has it been since you were first diagnosed?(Select
                                one)</label>
                        </div>
                        <div class="form-check">

                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="kidney[kidneydiagnosed]"
                                       value="1year"> 1year
                            </label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="kidney[kidneydiagnosed]" value="1-3">1-3
                                years
                            </label>
                        </div>
                        <div class="form-check">
                            ...
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="kidney[kidneydiagnosed]" value="3-5">3-5
                                years
                            </label>
                        </div>
                        <div class="form-check">
                        ...
                        <div class="form-group">
                            <div class="animated-checkbox">
                                <label>
                                    <input type="checkbox" name="kidney[kindeysymptomdiagnosed][]"
                                           value="bloodtest" <?= isChecked( 'kindeysymptomdiagnosed', 'bloodtest', 'kidney' ) ?>><span
                                            class="label-text">blood test(elevated creatinine)</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="kidney[kindeysymptomdiagnosed][]"
                                           value="protein" <?= isChecked( 'kindeysymptomdiagnosed', 'protein', 'kidney' ) ?>><span
                                            class="label-text">protein in the urine</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="kidney[kindeysymptomdiagnosed][]"
                                           value="other" <?= isChecked( 'kindeysymptomdiagnosed', 'other', 'kidney' ) ?>><span
                                            class="label-text">other:</span> &nbsp;&nbsp;
                                </label>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label">Have you been told what caused your kidney disease(e.g.
                                diabete,highblood pressure, glomerulonephritis, kidney stones, medication, related to
                                surgery or serve medical illness)?</label>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="animated-checkbox">
                                <label>
                                    <input type="checkbox" name="kidney[symptoms][]"
                                           value="kidneyproblem" <?= isChecked( 'symptoms', 'kidneyproblem', 'kidney' ) ?>><span
                                            class="label-text">kidney problems at birth or in childhood?</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="kidney[symptoms][]"
                                           value="hospitalized" <?= isChecked( 'symptoms', 'hospitalized', 'kidney' ) ?>><span
                                            class="label-text">hospitalized due to kidney faliure?</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="kidney[symptoms][]"
                                           value="anotherreason" <?= isChecked( 'symptoms', 'anotherreason', 'kidney' ) ?>><span
                                            class="label-text">kidney faliure while hospitalized for another reason?</span>
                                    &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="kidney[symptoms][]"
                                           value="stones" <?= isChecked( 'symptoms', 'stones', 'kidney' ) ?>><span
                                            class="label-text">kidney stones?</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="kidney[symptoms][]"
                                           value="bladder" <?= isChecked( 'symptoms', 'bladder', 'kidney' ) ?>><span
                                            class="label-text">bladder or kidney infection?</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="kidney[symptoms][]"
                                           value="difficulty" <?= isChecked( 'symptoms', 'difficulty', 'kidney' ) ?>><span
                                            class="label-text">difficulty emptying your bladder?</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="kidney[symptoms][]"
                                           value="urologic" <?= isChecked( 'symptoms', 'urologic', 'kidney' ) ?>><span
                                            class="label-text">Bladder or other urologic surgery?</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="kidney[symptoms][]"
                                           value="Radiation" <?= isChecked( 'symptoms', 'Radiation', 'kidney' ) ?>><span
                                            class="label-text">Radiation to the abdomen or pelvis</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="kidney[symptoms][]"
                                           value="Chemothrapy" <?= isChecked( 'symptoms', 'Chemothrapy', 'kidney' ) ?>><span
                                            class="label-text">Chemothrapy for cancer?</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="kidney[symptoms][]"
                                           value="family" <?= isChecked( 'symptoms', 'family', 'kidney' ) ?>><span
                                            class="label-text">family history of kidney disease?</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="kidney[symptoms][]"
                                           value="urine" <?= isChecked( 'symptoms', 'urine', 'kidney' ) ?>><span
                                            class="label-text">Blood in the urien?</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="kidney[symptoms][]"
                                           value="foamurine" <?= isChecked( 'symptoms', 'foamurine', 'kidney' ) ?>><span
                                            class="label-text">Foamy urien?</span> &nbsp;&nbsp;
                                </label>
                                <label>
                            </div>

                            <div class="form-group">
                                <label class="control-label">If you answered yes to any of the above, please enter more
                                    details here:</label>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="form-group" id="contentsmoker" style="display:none">
                        ...
                        <div class="form-group">
                            <div class="animated-checkbox">
                                <label>
                                    <input type="checkbox" name="smoker[modify][]"
                                           value="modify1" <?= isChecked( 'modify', 'modify1', 'smoker' ) ?>><span
                                            class="label-text">Sodium(salt)</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="smoker[modify][]"
                                           value="modify2" <?= isChecked( 'modify', 'modify2', 'smoker' ) ?>><span
                                            class="label-text">Cholestrol</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="smoker[modify][]"
                                           value="modify3" <?= isChecked( 'modify', 'modify3', 'smoker' ) ?>><span
                                            class="label-text">Saturated fat</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="smoker[modify][]"
                                           value="modify4" <?= isChecked( 'modify', 'modify4', 'smoker' ) ?>><span
                                            class="label-text">Sugar</span> &nbsp;&nbsp;
                                </label>
                                <label>
                                    <input type="checkbox" name="smoker[modify][]"
                                           value="modify5" <?= isChecked( 'modify', 'modify5', 'smoker' ) ?>><span
                                            class="label-text">Calories</span> &nbsp;&nbsp;
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="form-group" id="contentsugar" style="display:none">
                        ...
                        <div class="form-group">
                            <label class="control-label">What is the most challenging aspect of nutrition for
                                you?</label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" name="sugar[felt][]"
                                       value="sad" <?= isChecked( 'felt', 'sad', 'sugar' ) ?>>Sad
                            </label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" name="sugar[felt][]"
                                       value="scared" <?= isChecked( 'felt', 'scared', 'sugar' ) ?>>Scared
                            </label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" name="sugar[felt][]"
                                       value="stressed" <?= isChecked( 'felt', 'stressed', 'sugar' ) ?>>Stressed
                            </label>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label">Who have you seen recently for diabetes care?(Doctor's
                    ...
                    <di id="content" class="form-group">
                        ...
                        <br/>
                        <img src="<?= print_val( 'filename' ) ?>" style="max-width: 200px;"/>
                        <br/>
                        <br/>
                </div>
                <div class="form-group">
